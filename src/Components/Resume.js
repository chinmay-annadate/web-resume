    ...
    if(this.props.data){
      ...
      var projMan = this.props.data.projMan.map(function(projMan){
        return <div key={projMan.category}><h3>{projMan.category}</h3>
            <a className="certInfo" target="_blank" href={projMan.link5}>{projMan.certification5} {projMan.description5}</a> <span className='certInfo'> &bull; </span> <em className="certDate">{projMan.years5}</em>
